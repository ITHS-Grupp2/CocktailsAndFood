...
type Icon = "Cart" | "Arrow" | "Next" | "Cross";
...
export const GetIcon = (icon: Icon, size: Size) => {
  let text;
  switch (icon) {
    case "Cart":
      text = cartIcon(size);
